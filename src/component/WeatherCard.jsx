...
const WeatherCard = ({city, temp, description, feels , wind, cloud}) => {
  ...
  return (
    <div className='p-4 bg-white shadow rounded-lg flex items-center'>
        <div className='mr-5'>
            ...
            <p className='block'>wind speed: {wind}</p>
            <p>Cloud {cloud}%</p>
        ...
        <div className='border-l-2 pl-5'>
            ...
            <p className='text-2xl font-semibold'><span className='text-[18px]'>Feels Like: </span>{feels}°C</p>
        </div>
    </div>
  )
}
